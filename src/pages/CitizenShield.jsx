            ...
            <div className="chat-hdr">
              ...
              <div>
                ...
                <div className="ch-status">
                  {backendOnline ? '● Backend Active · Real-time Claude AI' : apiKey ? '● Claude API Active' : '● Smart Fallback Mode'}
                </div>
              </div>
                ...
                <div className="chat-msg bot">
                  <div className="msg-bbl">
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#94a3b8', fontSize: 12 }}>
                      ...
                      {backendOnline ? 'Claude AI analysing via backend...' : apiKey ? 'Claude claude-sonnet-4-6 analysing...' : 'Analysing...'}
                    </div>
                  </div>
                </div>
              )}
